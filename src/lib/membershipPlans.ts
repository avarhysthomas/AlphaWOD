...
export const MEMBERSHIP_SCHEMA_VERSION = 4;
...
export const POLICY_TEXT = {
  ...
  youthFamilyOffer: "Register two or more children for the same youth programme in one checkout and receive 10% off the full recurring monthly total while that subscription covers at least two children.",
