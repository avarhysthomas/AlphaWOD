...
export default function PBShareCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute left-1/2 top-[58%] h-[400px] w-[600px] -translate-x-1/2 -translate-y-1/2 select-none opacity-[0.15] bg-contain bg-center bg-no-repeat"
