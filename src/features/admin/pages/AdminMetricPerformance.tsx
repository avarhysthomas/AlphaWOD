                  ...
                  <div className="relative z-10 flex min-w-0 flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-2">
                        ...
                        <span className="inline-flex rounded-full border border-white/8 bg-white/[0.035] px-3 py-1 text-xs font-medium text-white/75">
                          ...
                          >
                            <div className="flex min-w-0 flex-1 items-center gap-3 sm:gap-4">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-white/30">
