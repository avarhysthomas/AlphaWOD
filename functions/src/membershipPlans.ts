...
/**
 * The exact versioned documents above are approved for customer publication.
 * The separately deployed Functions and frontend purchase environment gates
 * remain the operational controls for opening or closing new checkout intake.
 */
