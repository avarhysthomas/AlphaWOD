...
- Constraints: public and account-free; adult-only; name, date of birth, email, phone and waiver evidence; no reusable credit; no full private classes collection; responsive and keyboard-accessible; preserve the incumbent carbon-black, warm-white, amber-accent Zero Alpha system and existing logo/heading treatment.
